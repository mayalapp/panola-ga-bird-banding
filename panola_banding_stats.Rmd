...
# specific species of interest - change the species listed here if you are interested in creating a plot of one or more specific species (usually species that  do not reach the minimum number of observations and are not "key" grassland species)
my_species <- c("AMGO", "INBU") 

# location for analysis
# Usage note: you probably don't want to change this, but you can change this if you're interested in a different location
loc <- "PANO"
```
